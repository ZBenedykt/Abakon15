    ...
    public sealed class RegisteredUser
    {
        ...
        public static StateOfExecution CreateRegisteredUser(_Application _appState, _User user)
        {
            ...
            else
            {
                ...
                if (user.person != null)
                {
                    instance.allowedEquipments = PersonEquipment.AllowedEquipmentsToPerson(user.person);
                }
        ...
        public static void RequeryAllowedEquipment()
        {
            instance.allowedEquipments = PersonEquipment.AllowedEquipmentsToPerson(userInDB.person);
        }
