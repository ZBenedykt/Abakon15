...
namespace Abakon15.Reports
{
    public class ExcelDocument
    {
        ...
        public void CreateSpreadsheetDocument(string filePath, PrzyrzadPomiarowy equipment)
        {
            using (SpreadsheetDocument package = SpreadsheetDocument.Create(filePath, SpreadsheetDocumentType.Workbook))
            {
                CreateParts(package, equipment);
            }
        }

        // Adds child parts and generates content of the specified part.
        private void CreateParts(SpreadsheetDocument document, PrzyrzadPomiarowy equipment)
        {
            ...
            GenerateWorksheetPart1Content(worksheetPart1, equipment);
            ...
            GenerateSharedStringTablePart1Content(sharedStringTablePart1, equipment);
        ...
        private void GenerateWorksheetPart1Content(WorksheetPart worksheetPart1, PrzyrzadPomiarowy equipment)
        {
            Worksheet worksheet1 = new Worksheet() { MCAttributes = new MarkupCompatibilityAttributes() { Ignorable = "x14ac" } };
            worksheet1.AddNamespaceDeclaration("r", "http://schemas.openxmlformats.org/officeDocument/2006/relationships");
            worksheet1.AddNamespaceDeclaration("mc", "http://schemas.openxmlformats.org/markup-compatibility/2006");
            worksheet1.AddNamespaceDeclaration("x14ac", "http://schemas.microsoft.com/office/spreadsheetml/2009/9/ac");
            SheetDimension sheetDimension1 = new SheetDimension() { Reference = "C2:D4" };

            SheetViews sheetViews1 = new SheetViews();

            SheetView sheetView1 = new SheetView() { TabSelected = true, WorkbookViewId = (UInt32Value)0U };
            Selection selection1 = new Selection() { ActiveCell = "D7", SequenceOfReferences = new ListValue<StringValue>() { InnerText = "D7" } };
            ...
            Column column1 = new Column() { Min = (UInt32Value)3U, Max = (UInt32Value)3U, Width = 18D, CustomWidth = true };

            columns1.Append(column1);

            SheetData sheetData1 = new SheetData();

            Row row1 = new Row() { RowIndex = (UInt32Value)2U, Spans = new ListValue<StringValue>() { InnerText = "3:4" }, DyDescent = 0.25D };

            Cell cell1 = new Cell() { CellReference = "C2", StyleIndex = (UInt32Value)1U, DataType = CellValues.SharedString };
            CellValue cellValue1 = new CellValue();
            cellValue1.Text = "2";

            cell1.Append(cellValue1);

            Cell cell2 = new Cell() { CellReference = "D2", StyleIndex = (UInt32Value)2U, DataType = CellValues.SharedString };
            ...
            Row row2 = new Row() { RowIndex = (UInt32Value)3U, Spans = new ListValue<StringValue>() { InnerText = "3:4" }, DyDescent = 0.25D };

            Cell cell3 = new Cell() { CellReference = "C3", StyleIndex = (UInt32Value)1U, DataType = CellValues.SharedString };
            CellValue cellValue3 = new CellValue();
            cellValue3.Text = "0";

            cell3.Append(cellValue3);

            Cell cell4 = new Cell() { CellReference = "D3", StyleIndex = (UInt32Value)3U };
            CellValue cellValue4 = new CellValue();
            cellValue4.Text = equipment.PrzyrzadPomiarowyNrKod.ToString();
            ...
            Row row3 = new Row() { RowIndex = (UInt32Value)4U, Spans = new ListValue<StringValue>() { InnerText = "3:4" }, DyDescent = 0.25D };

            Cell cell5 = new Cell() { CellReference = "C4", StyleIndex = (UInt32Value)1U, DataType = CellValues.SharedString };
            CellValue cellValue5 = new CellValue();
            cellValue5.Text = "1";

            cell5.Append(cellValue5);

            Cell cell6 = new Cell() { CellReference = "D4", StyleIndex = (UInt32Value)2U, DataType = CellValues.SharedString };
        ...
        private void GenerateSharedStringTablePart1Content(SharedStringTablePart sharedStringTablePart1, PrzyrzadPomiarowy equipment)
        {
            ...
            Text text3 = new Text();
            text3.Text = "Nazwa przyrządu";

            sharedStringItem3.Append(text3);

            SharedStringItem sharedStringItem4 = new SharedStringItem();
            Text text4 = new Text() { Space = SpaceProcessingModeValues.Preserve };
            text4.Text = equipment.Nazwa;

            sharedStringItem4.Append(text4);

            SharedStringItem sharedStringItem5 = new SharedStringItem();
            Text text5 = new Text();
            text5.Text = equipment.NrEwid;
