...
namespace Abakon15.ViewModels
{
    public class MainWindowVM : ViewModelBase
    {
        ...
        RelayCommand m_EquipmentTypeDefinitionCommand = null;
        public RelayCommand EquipmentTypeDefinitionCommand
        {
            get
            {
                if (m_EquipmentTypeDefinitionCommand == null)
                {
                    m_EquipmentTypeDefinitionCommand = new RelayCommand(
                                                    param =>
                                                    {
                                                        WindowManagerClass.WindowOpener<EquipmentTypeWindow>(WindowContextEnum.empty, singleton: true);
                                                        //  WindowManagerClass.WindowOpener<DepartmentSelectionWindow>(WindowContextEnum.empty, singleton: true, dialog: true);
                                                    },
                                                    param => true
                                                    );
                }
                return m_EquipmentTypeDefinitionCommand;
            }
        }
        ...
        RelayCommand m_AirConditionDeviceCommand = null;
        public RelayCommand AirConditionDeviceCommand
        {
            get
            {
                if (m_AirConditionDeviceCommand == null)
                {
                    m_AirConditionDeviceCommand = new RelayCommand(
                                                    param =>
                                                    {
                                                        WindowManagerClass.WindowOpener<AirConditionDeviceWindow>(WindowContextEnum.empty, singleton: true);
                                                        //  WindowManagerClass.WindowOpener<DepartmentSelectionWindow>(WindowContextEnum.empty, singleton: true, dialog: true);
                                                    },
                                                    param => true
                                                    );
                }
                return m_AirConditionDeviceCommand;
            }
        }
