...
namespace Abakon15.ViewModels
{
    class LoginVM : ViewModelBase
    {
        ...
        private string _DbServer = Abakon15.Properties.Settings.Default._DB_server;
        ...
        private string _DbUser = Abakon15.Properties.Settings.Default._DB_user;
        ...
        private string _DbPassword = Abakon15.Properties.Settings.Default._DB_psw;
        ...
        private string _DbName = Abakon15.Properties.Settings.Default._DB_Name;
        ...
        internal LoginVM()
        {
            ...
            {
                AbakonDbContext cont = new AbakonDbContext();
                ...
                case "DbPassword":
                    {
                        ...
                        {
                            Abacon15.Properties.Settings.Default._DB_psw = Abakon15.Utility.RijndaelCrypto.EncryptString(DbPassword);
                        }
                        else
                        {
                            Abakon15.Properties.Settings.Default._DB_psw = "";
                        }
