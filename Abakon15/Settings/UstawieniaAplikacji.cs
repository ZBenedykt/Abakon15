...
namespace Abakon15.Settings
{
    class UstawieniaAplikacji
    {
        public static void SaveParameters()
        {
            Abakon15.Properties.Settings.Default._Language = myConverterCulture.CultureString;
            Abakon15.Properties.Settings.Default._partnerId_DGHeader = !Abakon15.Properties.Settings.Default._partnerId_DGHeader;
            Abakon15.Properties.Settings.Default._partnerCode_DGHeader = !Abakon15.Properties.Settings.Default._partnerId_DGHeader;
            Abakon15.Properties.Settings.Default.Save();
        }

        public static void LoadParameters()
        {
            myConverterCulture.GetCulture(Abakon15.Properties.Settings.Default._Language);
        }
