...
namespace Abakon15
{
    ...
    public partial class App : Application
    {
        ...
        private void Application_Startup(object sender, StartupEventArgs e)
        {
            ...
            Database.SetInitializer(new MigrateDatabaseToLatestVersion<AbakonDbContext, AbakonDataModel.Migrations.Configuration>());
            //=========================================================================
            ...
            if ((!login.DialogResult.HasValue || !login.DialogResult.Value) && Current != null) //!login.DialogResult.Value &&
            {
        ...
        private void Application_Exit(object sender, ExitEventArgs e)
        {
            try
            {
                ...
                _Application.ThisApplication().Sessions = Abakon15.Utility.XMLUtility.LoggedUsersRemove(_Application.ThisApplication().Sessions);
